...
# m個の条件でそれぞれn個体ずつ使用して実験を行い、条件ごとの遺伝子発現量の平均値を求める。
# インプットファイルは左から、「遺伝子名, 条件A-個体1, 条件A-個体2, 条件A-個体3, 条件B-個体1, 条件B-個体2,...」のような順に並んでいる。
# コマンドラインから、"python3 multi-average.py ファイル名 m n 出力ファイルの名前"と入力して実行。
